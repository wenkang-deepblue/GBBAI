...
with st.sidebar:
    ...
    st.page_link("pages/page_media_understanding.py", label="视频理解", icon="🎞️")
    st.page_link("pages/page_translation.py", label="文本翻译", icon="🇺🇳")
    st.page_link("pages/page_travel_advisor.py", label="旅游顾问", icon="✈️")
    st.page_link("pages/page_rag_search.py", label="RAG搜索", icon="🔍")
    st.page_link("pages/page_media_search.py", label="媒体搜索", icon="🎥")
    st.page_link("pages/page_image_generation.py", label="图片生成", icon="🎨")
    st.page_link("pages/page_chatbot.py", label="聊天机器人", icon="💬")
    st.page_link("pages/page_gaming_servicebot.py", label="游戏客服平台", icon="🤖")
    st.page_link("pages/page_ecommerce_servicebot.py", label="电商客服平台", icon="🤖")
    st.page_link("pages/page_claude_chatbot.py", label="Claude3.5聊天机器人", icon="💬")
    st.page_link("pages/page_llama_chatbot.py", label="Llama3.1聊天机器人", icon="💬")
